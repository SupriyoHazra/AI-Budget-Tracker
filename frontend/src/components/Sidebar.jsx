          ...
          >
            ...
            {!collapsed && (
              <button
                ...
                className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border border-white/[0.07] bg-white/[0.035] text-slate-500 transition hover:bg-white/[0.07] hover:text-white"
